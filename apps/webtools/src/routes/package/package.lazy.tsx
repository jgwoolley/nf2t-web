...
function SetFlowFileContent({onUpload, flowFile, setFlowFile}: PackageNifiProps) {
    return (
        <>
            <h5>1. FlowFile Content</h5>
            {(flowFile?.attributes.length || 0 )<= 0 ? (
                <>       
                ...
                <>
                    ...
                    <Button variant="outlined" onClick={() => setFlowFile(null)}>Clear</Button>
                </>
            )}
        </>
    )
